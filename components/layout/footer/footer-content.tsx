...
export default function FooterContent() {
  return (
    <div className="flex justify-between items-center gap-[154px] mb-12 ">
      <div>
        <Badge>
          <p className="text-xl">Contact us:</p>
        </Badge>
        <div className="space-y-5 text-white mt-7">
      ...
      <div className="flex-1 bg-[#292A32] py-14 px-10 flex justify-center items-center max-w-full">
        <div className="w-full flex justify-center items-center gap-5  max-w-full flex-wrap ">
          <input
            ...
            placeholder="Email"
          />
          <button className="h-[68px] bg-primary rounded-md leading-[0.28] text-nowrap px-9 max-w-full w-full">
            Subscribe to news
          </button>
        </div>
      </div>
